  ...
  return (
    <div style={{ width:"100%", borderRadius:12, overflow:"hidden",
      ...
      dangerouslySetInnerHTML={{ __html:
        `<wistia-player media-id="aqq109griy" aspect="1.7777777777777777" silent-auto-play="true"></wistia-player>`
      }}
    />
  );
}
      ...
      <div style={{ maxWidth:1120, margin:"0 auto" }}>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 pb-12" style={{ borderBottom:"1px solid rgba(255,255,255,.07)" }}>
          ...
          <div>
            ...
            <a href="/blog/contractor-estimate-time-management/" style={linkStyle} onMouseEnter={hoverIn} onMouseLeave={hoverOut}>The estimate time-drain fix</a>
